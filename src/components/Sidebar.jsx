...
const Sidebar = () => {
  return (
    <div className='bg-[#121212] w-[27.25%] h-[87%] py-1.5 px-2 flex-col gap-2 text-white hidden lg:flex m-2 rounded-lg'>
        <div className='h-[10%] rounded flex items-center justify-between px-4 mb-4'>
           <button className='flex items-center gap-3 opacity-50 hover:opacity-100 transition-opacity duration-200'>
            ...
            <button className='flex items-center opacity-50 hover:opacity-100 ml-[45%] transition-opacity duration-200'>
        ...
        <div className='bg-[#1F1F1F] flex flex-col w-[100%] h-[25%] rounded-lg px-5 py-4 mb-4 '>
          <h2 className='font-bold'>Create your first playlist</h2>
          <p className='text-sm font-medium pt-2'>It's easy, we'll help you</p>
          <button className='bg-white w-[35%] pb-2 pt-1 mt-4 rounded-full'>
        ...
        <div className='bg-[#1F1F1F] flex flex-col w-[100%] h-[25%] rounded-lg px-5 py-4 '>
          ...
          <button className='bg-white w-[40%] pb-2 pt-1 mt-4 rounded-full'>
